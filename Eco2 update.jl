...
1. En $t=1$:
   ...
   -  Una **función de producción** que depende de esa cantidad de trabajo $Y_1(L_1)$
2. Un **mercado de crédito** que relaciona la decisión de las familias de ahorrar hoy $S(\cdot)$ con las decisiones de inversión $I(\cdot)$.
3. En $t=2$:
   -  Un **mercado de trabajo** que determina $L_2$
   -  Un **mercado de capital** que determina $K_2$
   -  Una función de producción que depende de ambas variables $Y_1(L_2, K_2)$
"""
